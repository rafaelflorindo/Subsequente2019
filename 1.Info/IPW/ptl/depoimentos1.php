...
<!-- Grid column -->
  <div class="col-lg-4 col-md-12 mb-4">
         ...
         <!--Body-->
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <iframe class="embed-responsive-item" src=<?php echo $value["url"];?> allowfullscreen></iframe>
            </div>
          </div>
          <!--Footer-->
          <div class="modal-footer justify-content-center">
            <span class="mr-4">texto do modal</span>
    ...
    <a><img class="img-fluid z-depth-1" src="https://mdbootstrap.com/img/screens/yt/screen-video-1.jpg" alt="video"
        ...
        <span class="mr-4">Top 10 Violin Covers Of 2018 ( By Ember Trio )</span>
 </div>
  <!-- Grid column -->
<?php
       ...
       <!--Content-->
        <div class="modal-content">
         <!--Body-->
          <div class="modal-body mb-0 p-0">
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/7jftKK-3L54"
      ...
      <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <iframe class="embed-responsive-item" src="embed-responsive-item" src="https://www.youtube.com/embed/7jftKK-3L54"
                allowfullscreen></iframe>
            </div>
